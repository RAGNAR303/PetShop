                  ...
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    <div className="flex-1 flex items-start justify-between">
                      <div className="flex gap-3">
                        <span className="text-3xl flex py-2">{item.icon}</span>
                        <div>
                          <h3 className="font-bold text-xl lg:text-2xl  my-1">
                            {item.title}
                          </h3>
                          <p className="text-gray-400 text-sm select-none lg:text-[20px]">
                            {item.description}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a
                        href={`https://wa.me/5511965668190?text=Olá gostaria de mais informações sobre ${item.title}`}
                        target="_blank"
                        className="flex items-center justify-center gap-2 hover:text-red-400 duration-300"
                      >
